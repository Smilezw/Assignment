...
<head>
    ...
    <script src="http://cdnjs.cloudflare.com/ajax/libs/gsap/2.1.2/plugins/CSSPlugin.min.js"></script>
    <script src="http://cdnjs.cloudflare.com/ajax/libs/gsap/2.1.2/easing/EasePack.min.js"></script>
    <script src="http://cdnjs.cloudflare.com/ajax/libs/gsap/2.1.2/TweenLite.min.js"></script>
...
<body>
    <form class="default-form" action="login" method="post">
        <header class="default-form__form-title">
            <h1 class="default-form__form-title--main-title">Sign In</h1>
            <p class="default-form__form-title--subtitle">get an account, it's great!</p>
        </header>
        <div class="default-form__form-main-area">
            ...
            <input class="default-form__submit-button" type="submit" value="Sign In!" name="submit1">
            <input class="default-form__submit-button" type="submit" value="Register!" name="submit2">
        </div>
        <br>
        <%= (session.getAttribute("errorInfo") == null ? "" : session.getAttribute("errorInfo"))%>
    </form>
